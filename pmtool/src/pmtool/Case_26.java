...
public class Case_26 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("summary")).sendKeys("Task number one");
		driver.findElement(By.id("description")).sendKeys("This is task number one");
		...
		if ("Task number one".equals(in_prog_task_summ)) {
			System.out.println("Summary of task number one is correct");
		} else {
			System.out.println("Task number one creation failed due to wrong summary");
		}

		//Check if description is correct in view mode
		if ("This is task number one".equals(in_prog_task_desc)) {
			System.out.println("Description of task number one is correct");
		} else {
			System.out.println("Task number one creation failed due to wrong description");
		}
		
		//Check if labes are correct in view mode
		if ("BACKEND CI TESTING".equals(label_tags)) {
			System.out.println("Labels of task number one are correct");
		} else {
			System.out.println("Task number one creation failed due to wrong labels");
		}
		
		//Check if uploaded file name is correct in view mode
		if ("DUMMY_TEXT.TXT".equals(upload_file_name)) {
			System.out.println("Uploaded file name of task number one is correct");
		} else {
			System.out.println("Task number one creation failed due to wrong uploaded file name");
		}
		...
		driver.findElement(By.id("summary")).sendKeys("Task number two");
		driver.findElement(By.id("description")).sendKeys("This is task number two");
		...
		//Check if summary is correct in view mode
		if ("Task number two".equals(in_prog_task_summ)) {
			System.out.println("Summary of task number two is correct");
		} else {
			System.out.println("Task number two creation failed due to wrong summary");
		}

		//Check if description is correct in view mode
		if ("This is task number two".equals(in_prog_task_desc)) {
			System.out.println("Description of task number two is correct");
		} else {
			System.out.println("Task number two creation failed due to wrong description");
		}
				
		//Check if labes are correct in view mode
		if ("BACKEND CI TESTING".equals(label_tags)) {
			System.out.println("Labels of task number two are correct");
		} else {
			System.out.println("Task number two creation failed due to wrong labels");
		}
				
		//Check if uploaded file name is correct in view mode
		if ("DUMMY_TEXT.TXT".equals(upload_file_name)) {
			System.out.println("Uploaded file name of task number two is correct");
		} else {
			System.out.println("Task number two creation failed due to wrong uploaded file name");
		}
		...
		driver.findElement(By.id("summary")).sendKeys("Task number three");
		driver.findElement(By.id("description")).sendKeys("This is task number three");
		//Set status "In progress"
		driver.findElement(By.className("select-wrapper")).click();
		try {
		    Thread.sleep(1500);
		...
		//Check if summary is correct in view mode
		if ("Task number three".equals(in_prog_task_summ)) {
			System.out.println("Summary of task number three is correct");
		} else {
			System.out.println("Task number three creation failed due to wrong summary");
		}

		//Check if description is correct in view mode
		if ("This is task number three".equals(in_prog_task_desc)) {
			System.out.println("Description of task number three is correct");
		} else {
			System.out.println("Task number three creation failed due to wrong description");
		}
				
		//Check if labes are correct in view mode
		if ("BACKEND CI TESTING".equals(label_tags)) {
			System.out.println("Labels of task number three are correct");
		} else {
			System.out.println("Task number three creation failed due to wrong labels");
		}
				
		//Check if uploaded file name is correct in view mode
		if ("DUMMY_TEXT.TXT".equals(upload_file_name)) {
			System.out.println("Uploaded file name of task number three is correct");
		} else {
			System.out.println("Task number three creation failed due to wrong uploaded file name");
		}
		
		
		//Go in Task DB
		driver.findElement(By.id("task_db")).click();
		
		WebElement test_int = driver.findElement(By.id("items"));
		
		System.out.println(test_int.getSize());
