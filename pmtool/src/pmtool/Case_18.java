...
public class Case_18 {
	...
	public static void main(String[] args) {
		...
		in_prog_task_desc = driver.findElement(By.xpath("//*[@id='in_progress_items']/div/div/p")).getText();
		if (in_prog_task_desc.contains("(Updated)")) {
			System.out.println("Task editing was successful");
		} else {
			System.out.println("Task editing failed");
		}
		
		driver.findElement(By.id("dashboard")).click();
		
		//Delete Task 1 of Project 1
		driver.findElement(By.id("btn_view_tasks")).click();
		try {
		    Thread.sleep(400);
		} catch (InterruptedException ie) {
		...
		driver.findElement(By.id("btn_delete_task")).click();
		try {
		    Thread.sleep(400);
		} catch (InterruptedException ie) {
		    Thread.currentThread().interrupt();
        ...
        try {
        	...
        	System.out.println("Task deletion was successful");
        }
