...
public class Case_14 {
	...
	public static void main(String[] args) {
		...
		//Edit existing project attempt #1
		...
		driver.findElement(By.id("name")).sendKeys(Keys.chord(Keys.CONTROL,"a", Keys.DELETE));
		driver.findElement(By.cssSelector("button[name='action']")).click();
		try {
		    Thread.sleep(500);
		} catch (InterruptedException ie) {
		...
		if (required_field_msg.equals(expected_text)) {
			System.out.println("Succesfull scenario when name of project is missing");
		} else {
			System.out.println("Scenario failed! Mandatory field message is not printed when name of project is missing");
		}		
		
		driver.navigate().back();
		
		//Edit existing project attempt #2
		driver.findElement(By.id("btn_update_project")).click();
		try {
		    Thread.sleep(400);
		} catch (InterruptedException ie) {
		...
		//Edit existing project attempt #3
		driver.findElement(By.id("btn_update_project")).click();
		try {
		    Thread.sleep(400);
		} catch (InterruptedException ie) {
		...
		if (required_field_msg.equals(expected_text)) {
			System.out.println("Succesfull scenario when name of name of project is missing");
		} else {
			System.out.println("Scenario failed! Mandatory field message is not printed when name of name of project is missing");
		}	
